...
ki.log("Mid : " + str(cl.getProfile().mid))

#kk = LINE()
#kk.log("Auth Token : " + str(cl.authToken))
#kk.log("Mid : " + str(cl.getProfile().mid))

#kc = LINE()
#kc.log("Auth Token : " + str(cl.authToken))
#kc.log("Mid : " + str(cl.getProfile().mid))

#km = LINE()
#km.log("Auth Token : " + str(cl.authToken))
#km.log("Mid : " + str(cl.getProfile().mid))

#kb = LINE()
#kb.log("Auth Token : " + str(cl.authToken))
#kb.log("Mid : " + str(cl.getProfile().mid))

sw = LINE()
sw.log("Auth Token : " + str(cl.authToken))
sw.log("Mid : " + str(cl.getProfile().mid))
print("=LOGIN BOT YOU=")
